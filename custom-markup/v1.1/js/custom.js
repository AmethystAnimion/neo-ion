...
window.onload = function() {
  ...
  // for code
  data = data.replace(/\[code\]\[light\]/gm, '<pre class=\'code light\'>');
  data = data.replace(/\[code\]\[dark\]/gm, '<pre class=\'code dark\'>');
  ...
  data = data.replace(/\[info\]/gm, '<pre class=\'info\'>');
  data = data.replace(/\[\/info\]/gm, '</pre>');
  
  data = data.replace(/\[danger\]/gm, '<pre class=\'danger\'>');
  data = data.replace(/\[\/danger\]/gm, '</pre>');
  
  data = data.replace(/\[warning\]/gm, '<pre class=\'warning\'>');
  data = data.replace(/\[\/warning\]/gm, '</pre>');
  
  // link
  data = data.replace(/\[refto:\"/gm, '<a href=\'');
  data = data.replace(/\"\]/gm, '\'>');
  data = data.replace(/\[\/ref\]/gm, '</a>');
